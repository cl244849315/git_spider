...
p2 = r"^(\d\d\d).{3}\d{4}\s{2}.+[CM]\s+(?:.*\.\.\d+|.*)\n"#C      n3
p3 = r"^\d\d\d.{3}(\d{4})\s{2}.+[CM]\s+(?:.*\.\.\d+|.*)\n"
p4 = r"^\d\d\d.{3}\d{4}\s{2}.+([CM])\s+(?:.*\.\.\d+|.*)\n"
p5 = r"^\d\d\d.{3}\d{4}\s{2}.+[CM]\s+((?:.*\.\.\d+|.*))\n"

p6 = r"^(\d\d\d).{3}\d{4}\s{2}.+[^\d]$\n"
p7 = r"^\d\d\d.{3}(\d{4})\s{2}.+[^\d]$\n"
p8 = r"^\s{13}.+([CM])\s+(?:.*\.\.\d+|.*)\n"
p9 = r"^\s{13}.+[CM]\s+((?:.*\.\.\d+|.*))\n"

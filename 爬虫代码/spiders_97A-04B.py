...
def join(code_tag,year,ss):
	...
	for line2 in f2:
		...
		try:
			if  code_tag=='TUPREQ' and pos[i]=='0810' and matcher12[0]=='SDT':
				str11="%s,%s,%s,%s,%s,%s,%s,\"%s\"\n"%(pos[i],code_tag,matcher12[0],matcher11[0],year,matcher14[0],matcher13[0],'None')
				i=i+1
				zz=1
				f2_w.write(str11)
				f3_w.write(str11)
				continue
			str11="%s,%s,%s,%s,%s,%s,%s,\"%s\"\n"%(pos[i],code_tag,matcher12[0],matcher11[0],year,matcher14[0],matcher13[0],list_note[i-zz].strip('\n'))
...
if __name__=='__main__':
	# '97A','97B','98A','98B','99A','99B','00A',['00B','01A','01B','01C','02A','02B','03A','03B','04A','04B']
	year1=['02A','02B','03A','03B','04A','04B']

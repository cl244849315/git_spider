...
p1 = r"^\s{4}...(C\d\d\d)\s.+\n"#C002
p2 = r"^(\d\d\d)\s.\s{2}\d{4}\s{2}.+[CM]\s+(?:.*\.\.\d+|.*)\n"#C      n3
p3 = r"^\d\d\d\s.\s{2}(\d{4})\s{2}.+[CM]\s+(?:.*\.\.\d+|.*)\n"
p4 = r"^\d\d\d\s.\s{2}\d{4}\s{2}.+([CM])\s+(?:.*\.\.\d+|.*)\n"
p5 = r"^\d\d\d\s.\s{2}\d{4}\s{2}.+[CM]\s+((?:.*\.\.\d+|.*))\n"
#跨行的
p6 = r"^(\d\d\d)\s.\s{2}\d{4}\s{2}.+[^\d]$\n"
p7 = r"^\d\d\d\s.\s{2}(\d{4})\s{2}.+[^\d]$\n"
p8 = r"^\s{13}.+([CM])\s+(?:.*\.\.\d+|.*)\n"
p9 = r"^\s{13}.+[CM]\s+((?:.*\.\.\d+|.*))\n"
